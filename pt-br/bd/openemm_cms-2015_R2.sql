...
INSERT INTO `cm_text_version_tbl` (`id`, `admin_id`, `text`) VALUES (1,0,'Prezado usuário,\n\nEste e-mail só pode ser visualizado em formato HTML. Quase todos os leitores de e-mail suportam esse formato, no entanto, parece que seu cliente de e-mail bloqueou esse tipo de mensagem.\n\nDe qualquer forma, você pode acessá-la através de seu navegador:\n\nhttp://localhost:8080/form.do?agnCI=1&agnFN=fullview&agnUID=##AGNUID##\n\nSe você não deseja receber nossos e-mails, por favor, clique neste link:\n\nhttp://localhost:8080/form.do?agnCI=1&agnFN=unsubscribe&agnUID=##AGNUID##');
